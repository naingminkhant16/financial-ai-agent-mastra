...
export const financialAgent = new Agent({
    ...
    TOOLS
    - Use the getTransactionsTool to fetch financial transaction data.
    ...
    memory: new Memory({
        storage: new LibSQLStore({
            url: "file:../../memory.db"// local file system storage database. Location is relative to the output directory '.mastra/output'
        })
    })
})